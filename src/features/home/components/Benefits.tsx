    ...
    <section className="relative py-16 md:py-20 lg:py-24 overflow-hidden bg-gradient-to-b from-white to-emerald-50/30">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-16 md:mb-20 px-4 sm:px-0">
          {benefits.map((benefit, index) => (
            ...
            >
              ...
              {/* Card */}
              <div className={`relative h-full bg-white/95 backdrop-blur-sm rounded-2xl md:rounded-3xl border border-gray-100 p-6 md:p-8 shadow-lg hover:shadow-xl transition-all duration-300 ${visible[index] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
                }`}
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-0">
          {/* Glow Effect */}
          <div className="absolute inset-0 bg-gradient-to-r from-emerald-500/15 to-blue-500/15 blur-xl md:blur-3xl rounded-2xl md:rounded-3xl"></div>

          {/* Main CTA Card */}
          <div className="relative bg-gradient-to-br from-white via-white to-emerald-50/50 backdrop-blur-sm rounded-3xl border border-white/80 shadow-xl md:shadow-2xl overflow-hidden">
            <div className="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-emerald-500 via-blue-600 to-emerald-500"></div>

            <div className="relative z-10 p-8 md:p-12 lg:p-14 text-center">
              {/* Icons - Mejorados con un pequeño contenedor */}
              ...
              {/* Description */}
              <p className="text-base md:text-lg lg:text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                <a
                  ...
                  className="group w-full sm:w-auto inline-flex items-center justify-center gap-3 bg-gradient-to-r from-emerald-500 to-blue-600 text-white font-bold py-4 px-10 rounded-full shadow-lg shadow-emerald-200/50 hover:shadow-xl hover:shadow-emerald-200/80 transition-all duration-300 hover:scale-105 active:scale-95"
                >
                ...
                <a
                  ...
                  className="group inline-flex items-center gap-3 text-gray-700 hover:text-emerald-600 font-bold transition-all duration-300 py-2"
                >
                  ...
                  <span className="text-base">Llamar ahora</span>
                </a>
              </div>
            </div>
          </div>
